...
import { activeGames, determineGameResult, type MovePayloadType, playerRooms, updateFriendStatus } from "../utils"

const registerGameEvents = (io: Server, socket: Socket) => {
  const { userId } = socket.data

  socket.on("game:move", ({ from, promotion, to }: MovePayloadType) => {
